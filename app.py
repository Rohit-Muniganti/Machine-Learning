...
model = pickle.load(open(r'C:\Users\rohit\OneDrive\Desktop\FSDS & GEN-AI 25TH-NOV-024.NOTES\SPYDER\regressor.pkl', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by Rohit Muniganti")